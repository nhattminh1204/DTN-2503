...
public enum ErrorCode {
    ...
    USERNAME_ALREADY_EXISTS(1003, "Tên người dùng đã tồn tại", HttpStatus.BAD_REQUEST),
    INVALID_CREDENTIALS(1004, "Tên người dùng hoặc mật khẩu không đúng", HttpStatus.UNAUTHORIZED),
    USER_EXISTS(1005, "Tài khoản đã tồn tại", HttpStatus.BAD_REQUEST),
    ...
    COURSE_NAME_EXISTS(2002, "Tên khoá học đã tồn tại", HttpStatus.BAD_REQUEST),
    ...
    CATEGORY_ID_REQUIRED(2008, "Vui lòng cung cấp ID danh mục", HttpStatus.BAD_REQUEST),
    CERTIFICATE_ID_INVALID(2009, "ID chứng chỉ không hợp lệ hoặc không tồn tại", HttpStatus.BAD_REQUEST),
    ...
    CATEGORY_HAS_NO_COURSE(3004, "Danh mục không có khoá học nào", HttpStatus.NOT_FOUND),
    CATEGORY_NAME_EXISTS(3005, "Tên danh mục đã tồn tại", HttpStatus.BAD_REQUEST),
    ...
    CERTIFICATE_HAS_COURSES(5005, "Chứng chỉ vẫn đang được sử dụng trong khóa học", HttpStatus.BAD_REQUEST),
    CERTIFICATE_ID_REQUIRED(5006, "Vui lòng cung cấp ID chứng chỉ", HttpStatus.BAD_REQUEST),
    COURSE_CERTIFICATE_NULL(5007, "Khoá học chưa được gán chứng chỉ", HttpStatus.BAD_REQUEST),
    CERTIFICATE_TYPE_EXISTS(5008, "Loại chứng chỉ đã tồn tại", HttpStatus.BAD_REQUEST),
